...
public class GroupConsumerService {
    ...
    @KafkaListener(topics = "group-created",containerFactory = "kafkaListenerContainerFactory")
    ...
    @KafkaListener(topics = "group-updated",containerFactory = "kafkaListenerContainerFactory")
